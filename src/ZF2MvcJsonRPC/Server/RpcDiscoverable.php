...
/**
 * Declare the annotation. Maybe useful in future to replace @rpcDiscoverable
 *
 * @todo: evaluate the impact of substituting the current annotation with doctrine standard
 *
 */
namespace ZF2MvcJsonRPC\Server;

/**
 * Class RpcDiscoverable
